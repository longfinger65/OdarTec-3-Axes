...
Public Class cSketch
    ...
    Public Function addElement(Element As cCADObject) As String
        ...
        Select Case Element.GetType()
            ...
            Case GetType(cSimplePoint)
                Do
                    k += 1
                Loop Until (Sketch.Contains("SimplePoint" + CStr(k)) = False)
                Sketch.Add(Element, "SimplePoint" + CStr(k))
                Sketch.Item(Sketch.Count).SketchName = NameOfEntity
                Sketch.Item(Sketch.Count).NameOfEntity = "SimplePoint" + CStr(k)
                Sketch.Item(Sketch.Count).TypeOfEntity = "SimplePoint"
                ElementKey = "SimplePoint" + CStr(k)
